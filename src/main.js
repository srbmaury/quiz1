...
for (var i = 1; i <= 5; i++) setDisplayNone(document.getElementById(arr[i]));
...
setDisplayNone(res, introduction, showproblems, befres, countdown);
...
function showPrev(a, b) {
        setDisplayNone(document.getElementById(a));
        document.getElementById(b).style.display = "block";
}
function showQue(a, b) {
        if (b == 'introduction') setDisplayNone(document.getElementById("callByName"));
...
function updateCountdown() {
        ...
        if (minutes == 0 && seconds == 0) {
                ...
                setDisplayNone(introduction, showproblems, befres, countdown);
